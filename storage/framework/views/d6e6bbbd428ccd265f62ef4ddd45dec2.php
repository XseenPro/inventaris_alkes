...
<head>
    <meta charset="utf-8">
    <title>Resume Mutasi – <?php echo e($periodeLabel); ?></title>
    <style>
        body {
...
<body>
    <table style="width: 100%; border-bottom: 3px double #000000; padding-bottom: 10px;">
        <tr>
            <td style="width: 20%; text-align: right; border: 0; vertical-align: top;">
                <img src="<?php echo e(public_path('img/RSU.png')); ?>" alt="Logo RS" style="width: 80px; height: auto;">
            </td>
            ...
            <td style="width: 20%; text-align: left; border: 0; vertical-align: top;">
                <img src="<?php echo e(public_path('img/KARS.png')); ?>" alt="Logo RS" style="width: 110px; height: auto;">
            </td>
        </tr>
    </table>
    <br><br><br>
        ...
        <tr>
            <td style="width: 60%; text-align: center; border: 0; vertical-align: top;">
                <h3 style="margin: 0; font-size: 16px; font-weight: normal;">RESUME MUTASI BARANG IT RSU MITRA
                    PARAMEDIKA <?php echo e($periodeLabel); ?>
    ...
    <!-- <table class="mt" style="margin-bottom:10px;">
        ...
        <tr>
            <td class="right"><?php echo e($summary['total']); ?></td>
            <td class="right"><?php echo e($summary['diterima']); ?></td>
            <td class="right"><?php echo e($summary['pending']); ?></td>
            <td class="right"><?php echo e($summary['baik']); ?></td>
            <td class="right"><?php echo e($summary['rusak']); ?></td>
        </tr>
    </table> -->
...
</html><?php /**PATH E:\Magang\Inventaris AlKes\inventory-alkes\resources\views/exports/mutasi-resume-pdf.blade.php ENDPATH**/ ?>